...
public class PlanEjercicioServiceImpl implements PlanEjercicioService {
    ...
    public List<PlanResumenDTO> listarPlanesPorCliente(Long clienteId) {
        ...
        List<PlanResumenDTO> lista = planEjercicioRepository.findByClienteIdCliente(clienteId.intValue()).stream()
    ...
    private PlanEjercicioDTO mapEntityToDto(PlanEjercicio entity) {
        return PlanEjercicioDTO.builder()
                .id(entity.getIdPlan() != null ? entity.getIdPlan().longValue() : null)
